 ...
 */
public class MyHeaderPositionCalculator {
    ...
    public MyHeaderPositionCalculator(StickyRecyclerHeadersAdapter adapter, HeaderProvider headerProvider,
    ...
    private void initDefaultHeaderOffset(Rect headerMargins, RecyclerView recyclerView, View header, View firstView, int orientation) {
        ...
        if (orientation == LinearLayoutManager.VERTICAL) {
            ...
            translationY = firstView.getTop() - header.getHeight();
        } else {
