 ...
 * </p>
 */
public class SkeletonRefreshLayout extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = MaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MaterialProgressDrawable.DEFAULT;

    private static final String LOG_TAG = SkeletonRefreshLayout.class.getSimpleName();
     ...
     * @param context
     */
    public SkeletonRefreshLayout(Context context) {
        this(context, null);
    }
